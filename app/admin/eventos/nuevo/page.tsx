...
export default function NuevoEventoPage() {
  ...
  // INICIALIZACIÓN DINÁMICA CON PREDETERMINADOS (País incluye la matriz inteligente y extensa)
  useEffect(() => {
    setFields([
