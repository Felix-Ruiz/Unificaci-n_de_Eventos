        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <AccordionSection id="detalles" icon={Settings} title="Detalles y Diseño Base" isOpen={openSection === 'detalles'} onToggle={toggleSection}>
            ...
            <div className="space-y-1.5 pb-4">
              ...
              <div className="bg-white dark:bg-black/50 border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden [&_.ql-toolbar]:border-0 [&_.ql-toolbar]:border-b [&_.ql-toolbar]:border-gray-300 dark:[&_.ql-toolbar]:border-gray-700 [&_.ql-container]:border-0 [&_.ql-editor]:min-h-37.5 [&_.ql-editor]:text-gray-900 dark:[&_.ql-editor]:text-white">
                <ReactQuill 
                  theme="snow"
